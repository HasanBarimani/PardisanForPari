...
namespace Pardisan.Extensions
{
    public static class PublicHelper
    {
        ...
        public class FilePath
        {
            ...
            public const string EstateImagePath = "img\\Estate";
            public const string HodlingImagePath = "img\\Holding";
            public const string SliderImagePath = "img\\Slider";
            public const string WaterMarkImagePath = "img\\watermark.png";
            public const string EstateImagePathForShow = "/img/Estate/";
            public const string HodlingImagePathForShow = "/img/Holding/";
            public const string SliderImagePathForShow = "/img/Slider/";
        ...
        public class FileUploader
        {
            ...
            public static (bool succsseded, string result) UploadImage(IFormFile file, string path, string watermarkpath, bool isWaterMark, int maxLength = _maxImageLength, int width = (int)ImageWidth.Unset, int height = (int)ImageHeight.Unset, int compression = (int)ImageComperssion.Normal, string format = "default")
            {
                ...
                try
                {
                    ...
                    if (isWaterMark)
                    {
                        // اضافه کردن مسیر فایل تصویر واترمارک
                        var watermark = Image.Load(watermarkpath);
                        // تغییر اندازه واترمارک بر اساس اندازه تصویر اصلی
